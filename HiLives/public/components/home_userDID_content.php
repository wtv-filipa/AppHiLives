    ...
    <div class="cards">
        <div class="card-item">
            ...
            <div class="card-info">
                ...
                <p class="card-intro description_title">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
            </div>
        </div>
    </div>
    <div class="cards">
