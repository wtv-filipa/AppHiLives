                        ...
                        <ul>
                            ...
                            <li title="Disciplinas">
                                <label for="tab1" role="button">
                                    <svg class="bi bi-award-fill" width="1em" height="1em" viewBox="0 0 16 16"
                            ...
                            <li title="Áreas de interesse">
                                <label for="tab2" role="button">
                                    <svg class="bi bi-file-ruled" width="1em" height="1em" viewBox="0 0 16 16"
                                         fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li title="Competências">
                                <label for="tab3" role="button">
                                    <svg class="bi bi-person-check-fill" width="1em" height="1em" viewBox="0 0 16 16"
                                         fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd"
                            ...
                            <li title="Ambientes de trabalho">
                                <label for="tab4" role="button">
                                    <svg class="bi bi-briefcase-fill" width="1em" height="1em" viewBox="0 0 16 16"
                                         fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd"
