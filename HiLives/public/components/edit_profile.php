<div class="card text-center">
    ...
    <hr>
        ...
        <form class="form-horizontal row" role="form">
            ...
            <!--terceiro input-->
            <div class="form-group text-left">
                <label for="tlm">Número de telemóvel:</label>
            ...
            <!--quinto input-->
            <div class="form-group text-left">
                <label for="def">Defeciência:</label>
                <input type="text" id="def" name="def" class="form-control">
            </div>
            <!----------------------->
            <!--sexto input-->
            <div class="form-group text-left">
                <label for="laudo">Data do laudo:</label>
                <input type="date" id="laudo" name="laudo" class="form-control">
            </div>
            <!----------------------->
            <!--sétimo input-->
            <div class="form-group text-left">
                <label for="escola">Nível de educação escolar:</label>
            ...
            <!--oitavo input-->
            <div class="form-group text-left">
                <label for="xp">Experiência de trabalho:</label>
