            ...
            <div class="row col-12 m-0 p-0 my-auto">
                ...
                if (isset($_SESSION["idUser"])) {
                    ...
                    <div id="mySidenav" class="sidenav">
                        <a href="javascript:void(0)" class="closebtn" aria-label="Fechar"
                    ...
                    <div class="col-4 text-left p-0 my-auto">
                        <span onclick="openNav()" class="menu_lado">
                            <i class="fas fa-ellipsis-v" title="Eu quero"
                               style="color: #2f2f2f; font-size: 25px !important; ">
                ...
                <div class="col-4 p-0 text-right my-auto">
                    ...
                    if (isset($_SESSION["idUser"])) {
                        ...
                        <div class="dropdown">
                                ...
                                if (mysqli_stmt_fetch($stmt)) {
                                    if ($status == 1) {
                                        ...
                                        <button id="<?= $idUser ?>" class="btn pl-0 noti" type="button" role="button" data-toggle="dropdown">
                                            <img src="img/notif_on.png" alt="Símbolo de notificações" title="Notificações"
                                                 style="position:relative; max-width:25px">
                                        ...
                                        ?>
                                        <button id="<?= $idUser ?>" class="btn pl-0 noti" type="button" role="button" data-toggle="dropdown">
                                            <img src="img/notif.png" alt="Símbolo de notificações" title="Notificações"
                                                 style="position:relative; max-width:25px">
                                            <span class="nome ml-2">O que está a acontecer</span>
                                        </button>
                                        <?php
                            ...
                            <ul class="dropdown-menu dropdown-menu-right dropdown-menu1 mx-auto tamanho"
                    ...
                    <div class="dropdown ">
                            ...
                            while (mysqli_stmt_fetch($stmt)) {
                                ...
                                if (isset($profile_img)) {
                                    ...
                                    <button class="btn pl-0 pr-0 " type="button" role="button" id="dropdownMenuButton"
                                        ...
                                        <img class="nav__avatar--image" style="max-width:25px" alt="Imagem de perfil"
                                             title="<?= $name_user ?>"
                                    ...
                                    <button class="btn pl-0 pr-0" type="button" role="button" data-toggle="dropdown">
                                        <img src="img/no_profile_img.png" class="nav__avatar--image "
                                             style="max-width:25px" alt="Imagem de perfil padrão">
                                        <span class="nome paddings ml-1" style="color: black"><?= $nome ?></span>
                                    </button>
                                    <?php
                                }
                        ...
                        mysqli_close($link);
                        ?>
                        <div class="dropdown-menu dropdown-menu-right alinhar_user mx-auto "
                            ...
                            <a href="scripts/logout.php">
                                <button class="nav__btn2 nav__btn3" style="background: #FDE74C;"><i
                                            class="fa fa-sign-out mr-2"></i>Sair
                                </button>
                            </a>
                        </div>
                    </div>
