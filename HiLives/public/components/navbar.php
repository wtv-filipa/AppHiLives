                    ...
                    if (isset($_SESSION["idUser"])) {
                        ...
                        <div class="dropdown">
                            <button class="btn pl-0" type="button" role="button" data-toggle="dropdown">
                                <img src="img/notif.png" alt="Símbolo de notificações"
                                     style="position:relative; max-width:25px"><span class="nome ml-2">O que está a acontecer</span>
                            </button>
                            <ul class="dropdown-menu dropdown-menu-right dropdown-menu1 mx-auto"
                                ...
                                if (mysqli_stmt_prepare($stmt, $query12)) {
                                    ...
                                    mysqli_stmt_bind_result($stmt, $text_noti, $date, $User_idUser);
